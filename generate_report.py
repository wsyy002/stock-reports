...
def main():
    ...
    # ═══════════════════════════════════
    print("\n▶ 步骤2: 市场消息整理...")
    news_brief = ("本周A股缩量阴跌，周五主要指数盘中一度跌超2%，午后深V收窄（沪指-1.18%、创业板-0.49%），全周成交9.46万亿创年内新低、连续第5周缩量，超4000股下跌。"
                  "主力资金逆势加仓电子(+597亿)/通信(+275亿)/国防军工，元器件、PCB、MLCC周五逆势涨停潮；贵金属、有色受美PPI超预期+加息预期拖累大跌。"
                  "政策面《金融强国建设“十五五”规划》、工信部《“人工智能+软件”专项行动》落地；下周美联储大概率加息，外部风险待释放。")
